...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // MongoDB / Login Logic handles here...
            alert("Registration logic connects here!");
        } catch (err) {
        ...
        <div className="bg-transparent flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p className="mt-2 text-center text-sm text-[#2C2520]/70">
                    Or{" "}
                    <Link href="/login" className="font-bold text-[#4A6761] hover:underline transition">
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <div className="bg-[#EAE3DA] py-8 px-4 shadow-md sm:rounded-lg sm:px-10 border border-[#DCD3C7]">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        {/* Name Input */}
                        <div>
                            <label htmlFor="name" className="block text-sm font-bold text-[#2C2520]">
                                Full Name
                            </label>
                        ...
                        {/* Email Input */}
                        <div>
                            <label htmlFor="email" className="block text-sm font-bold text-[#2C2520]">
                                Email address
                            </label>
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        {/* Password Input */}
                        <div>
                            <label htmlFor="password" className="block text-sm font-bold text-[#2C2520]">
                                Password
                            </label>
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
